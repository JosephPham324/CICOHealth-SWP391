    ...
    <%@page contentType="text/html" pageEncoding="UTF-8" %>
        <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            ...
            <head>
                ...
                <link rel="stylesheet"
                    href="${pageContext.request.contextPath}/assets/sass/main/exercisemanagement.css" />
            ...
            <body>
                        ...
                        <div class="pop-up-content">
                            <form id="edit-exercise-form" action="/CICOHealth/admin/exercise-management" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="txtExerciseID" name="txtExerciseID" type="text" class="form-control"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="txtExerciseType" name="txtExerciseType" type="text"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="txtExerciseName" name="txtExerciseName"
                                            placeholder="Enter Exercise Name" type="text" class="form-control"
                                            required="required" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="txtExerciseDescription" class="col-4 col-form-label">Exercise
                                        Description</label>
                                    <div class="col-8">
                                        <textarea id="txtExerciseDescription" name="txtExerciseDescription" cols="40"
                                            rows="3" required="required" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="numCaloriePerHour" class="col-4 col-form-label">Calorie Per Hour</label>
                                    <div class="col-8">
                                        <input id="numCaloriePerHour" name="numCaloriePerHour" type="number" step="0.1"
                                            class="form-control" aria-describedby="numCaloriePerHourHelpBlock" />
                                        <span id="numCaloriePerHourHelpBlock"
                                            class="form-text text-muted">Optional</span>
                                    </div>
                                </div>
             ...
             padding-top: 3rem;">
                        <h1 class="exericse-management-title">Exercise Management</h1>
                        <div class="row  justify-content-md-center">
                            <div class="col-md-auto">
                                <div class="content">
                                    <table id="info-table"
                                        class="table table-striped table-hover display content-table">
                                        <thead>
                                            <tr style="background-color: rgb(131, 184, 46);">
                                            ...
                                            <c:forEach var="exercise" items="${exerciseList}">
                                                <tr>
                                                    ...
                                                    "caloriesPerHour": "${exercise.caloriesPerHour}"
                                                        ...
                                                        <form action="/CICOHealth/admin/exercise-management"
                                    ...
                                    <button name="submit" class="btn btn-submit btn-add-exercise" id="add-button">
                                        Add Exercise
                                    </button>
                                </div>
                            </div>
