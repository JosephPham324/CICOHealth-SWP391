    ...
    <div class="pop-up" id="edit-exercise-popup">
      ...
      <div class="pop-up-content">
        <form id = "edit-exercise-form" action="/CICOHealth/admin/exercise-management" method="POST">
          ...
          <div class="form-group row">
            <label for="txtExerciseID" class="col-4 col-form-label"
              >Exercise ID</label
            >
            <div class="col-8">
              <input
          ...
          <div class="form-group row">
            <label for="txtExerciseType" class="col-4 col-form-label"
              >Exercise Type</label
            >
            <div class="col-8">
              <input
                id="txtExerciseType"
                name="txtExerciseType"
                type="text"
                class="form-control"
                required="required"
                readonly
          ...
          <div class="form-group row">
            <label for="txtExerciseName" class="col-4 col-form-label"
              >Exercise Name</label
            >
            <div class="col-8">
              <input
          ...
          <div class="form-group row">
            <label for="txtExerciseDescription" class="col-4 col-form-label"
          ...
          <div class="form-group row">
            <label for="numCaloriePerHour" class="col-4 col-form-label"
              >Calorie Per Hour</label
            >
            <div class="col-8">
              <input
                id="numCaloriePerHour"
                name="numCaloriePerHour"
                type="number"
                step="0.1"
                class="form-control"
                aria-describedby="numCaloriePerHourHelpBlock"
              />
              <span id="numCaloriePerHourHelpBlock" class="form-text text-muted"
                >Optional</span
              >
            </div>
          </div>
