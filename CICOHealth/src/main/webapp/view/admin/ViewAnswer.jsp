...
<html>
    ...
    <body>
        ...
        <div class="info-container">
            <button><a href="/CICOHealth/view/admin/addAnswer.jsp">Add</a></button>
            <div class="info-table">            
                <table id="info-table" class="table table-striped table-hover display">
                    ...
                    <tbody>
                        ...
                        <form action="/CICOHealth/faq/answers" method="post" onSubmit="return confirm('Do you want to delete?')">     
                            <tr>
