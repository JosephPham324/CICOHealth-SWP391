<%-- Document : ViewUserInfo Created on : Feb 14, 2023, 11:28:09 AM Author : User --%>
                ...
                <%@page contentType="text/html" pageEncoding="UTF-8" %>
                    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
                        ...
                        <head>
                            ...
                            <link rel="stylesheet"
                                href="${pageContext.request.contextPath}/assets/css/adminuserinfo.css">
                                        ...
                                        <div class="col-md-auto">
                                            <div class="content">
                                                ...
                                                <table class="content-table" id="users-table">
                                                    ...
                                                    <tbody>
                                                        <% UserDao dao=new UserDao(); List<User> users =
                                                            dao.getAllUser();
                                                            for (User list : users) {%>
                                                            <tr class="table-active">
                                                                ...
                                                                <td>
                                                                    <a class="fa-solid fa-pen-to-square edit-button"
                                                                        style="color: blue;"
                                                                        href="/CICOHealth/user/profile/user-info?userid=<%= list.getUserID()%>"></a>
                                                                    <c:set var="us" scope="session"
                                                                        value="<%= list.getUserID()%>" />
                                                                    <c:set var="banned" scope="session"
                                                                        value="<%= list.isIsBanned()%>" />
                                                                    <c:if test="${banned}">
                                                                        <a class="unbaned" id="banned" data-value="1"
                                                                            onclick="changeStatus('<%= list.getUserID()%>', this)"><i
                                                ...
                                                <button name="submit" class="btn btn-submit" id="add-button">
                                                    Add Account
                                                </button>
                                            </div>
                                        </div>
