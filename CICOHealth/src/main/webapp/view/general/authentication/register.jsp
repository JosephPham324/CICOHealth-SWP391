                ...
                <form action="register" method="post" id="register-form" class="login-form">
                    <div class="login-form-content">
                        ...
                        <div class="form-item">
                            ...
                            <div class="col-8">
                                <input required="required" id="txtUsername" name="txtUsername"
                        ...
                        <div class="form-item" id="password-field">
                            ...
                            <div class="col-8">
                                <input required="required" id="txtPassword" name="txtPassword"
                        ...
                        <div class="form-item">
                            ...
                            <div class="col-8">
                                <input required="required" id="txtEmail" name="txtEmail"
                                       placeholder="Enter your email address" type="text" class="form-control" />
                            </div>
                        </div>
                        <div class="form-item">
                            <label for="txtPhone" class="col-4 col-form-label">Phone</label>
                            <div class="col-8">
                                <input required="required" id="txtPhone" name="txtPhone"
