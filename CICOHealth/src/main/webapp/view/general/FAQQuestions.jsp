<%-- Document : FAQQuestions Created on : Feb 28, 2023, 1:29:36 PM Author : Pham
...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="/CICOHealth/assets/sass/main/faq.css"
    />
      ...
      <div class="pop-up-content answer-pop-up-content">
        ...
        >
          ...
          <div class="form-group row">
            <label for="txtQuestionTopic" class="offset-1 col-3 col-form-label"
              >Question topic</label
            >
            <div class="col-7">
              <select
                name="txtQuestionTopic"
                id="txtQuestionTopic"
                class="form-control"
                disabled
              >
          ...
          <div class="form-group row">
            <label for="txtName" class="offset-1 col-3 col-form-label"
          ...
          <div class="form-group row">
            <label for="txtAnswerContent" class="offset-1 col-3 col-form-label"
  ...
  <script
    type="module"
    src="/CICOHealth/assets/scripts/faqQuestion.js"
  ></script>
