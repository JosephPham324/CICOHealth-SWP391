    ...
    <div class="container">
            ...
            <div class="create-exercise-program-form-content">
                ...
                <div class="card list-exercise-program-item">
                    ...
                    <div class="card-body collapse" data-toggle="collapse" aria-expanded="false" id="program1">
                        ...
                        <div class="form-item row">
                            <div class="offset-2 col-2">
                                <label for="txtExerciseOrder">Exercise Order</label>
                            </div>
                            <div class="col-6 form-item-input">
                                <input id="txtExerciseOrder" name="txtExerciseOrder" placeholder="Enter exercise order"
                                    type="text">
                            </div>
                        </div>
                        <div class="form-item row">
                            <div class="offset-2 col-2">
                                <label for="txtSet">Set</label>
                            </div>
                            <div class="col-6 form-item-input">
                                <input id="txtSet" name="txtSet" placeholder="Enter set number" type="text">
                            </div>
                        </div>
                        <div class="form-item row">
                            <div class="offset-2 col-2">
                                <label for="txtRep">Rep</label>
                            </div>
                            <div class="col-6 form-item-input">
                                <input id="txtRep" name="txtRep" placeholder="XX/XX/XX..." type="text">
                            </div>
                        </div>
                        <div class="form-item row">
                            <div class="offset-2 col-2">
                            ...
                            <div class="col-6 form-item-input">
                                <input id="txtWeight" name="txtWeight" placeholder="XX/XX/XX..." type="text">
                            </div>
                        </div>
                        <div class="form-item row">
                            <div class="offset-2 col-2">
                            ...
                            <div class="col-6 form-item-input">
                                <input id="txtDuration" name="txtDuration" placeholder="Enter duration" type="text">
                            </div>
                        </div>
                        <div class="form-item row">
                            <div class="offset-2 col-2">
                                <label for="txtInstruction">txtInstruction</label>
                            </div>
                            <div class="col-6 form-item-input">
                                <textarea name="txtInstruction" id="txtInstruction" cols="30" rows="5"
        ...
        <!-- <div class="pop-up create-exercise-pop-up" id="create-exercise-pop-up">
            ...
            <div class="pop-up-content create-exercise-pop-up-content">
                <form action="create-exercise" method="post" name="create-exercise-form" id="create-exercise-form" class="create-exercise-form">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-7">
                            <input id="txtSetPopUp" name="txtSetPopUp" type="text" class="form-control" placeholder="Enter set number">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="txtRepPopUp" class="offset-1 col-3 col-form-label">Rep</label>
                        <div class="col-7">
                            <input id="txtRepPopUp" name="txtRepPopUp" type="text" class="form-control" placeholder="Enter rep with format XX/XX/XX...">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="txtWeightPopUp" class="offset-1 col-3 col-form-label">Weight</label>
                        <div class="col-7">
                            <input id="txtWeightPopUp" name="txtWeightPopUp" type="text" class="form-control" placeholder="Enter weight with format XX/XX/XX...">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="txtDurationPopUp" class="offset-1 col-3 col-form-label">Duration</label>
                        <div class="col-7">
                            <input id="txtDurationPopUp" name="txtDurationPopUp" type="text" class="form-control" placeholder="Enter duration">
                        </div>
                    </div>
                    <div class="form-group row">
        ...
        <div class="pop-up create-exercise-pop-up" id="create-exercise-pop-up">
            <div class="create-exercise-overlay overlay" id="overlay"></div>
            <div class="pop-up-content create-exercise-pop-up-content">
                <form action="create-exercise" method="post" name="create-exercise-form" class="create-exercise-form"
