...
<link
    rel="stylesheet"
    href="${pageContext.request.contextPath}/assets/sass/main/navbar.css"
    />
...
<link
    rel="stylesheet"
    href="${pageContext.request.contextPath}/assets/sass/main/card.css"
    />
...
<c:set var="user" value="${sessionScope.user}"></c:set>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand me-2" href="/CICOHealth/"
               >CICO<span class="nav-title">Health</span>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarButtonsExample">
                ...
                <c:choose>
                    <c:when test="${user!=null}">
                        <li class="nav-item">
                            <a class="nav-link" href="/CICOHealth/exercise-programs">Programs</a>
                        </li>
                    </c:when>
                </c:choose>
            </ul>
            <c:choose>
                ...
                <c:otherwise>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li>
                                <a class="dropdown-item" href="/CICOHealth/user/profile"
                                   >Profile</a
                                >
                            </li>
                            <li>
                                <a class="dropdown-item" href="/CICOHealth/user/meal-logs"
                                   >Meals Log</a
                                >
                            </li>
                            <li>
                                <a class="dropdown-item" href="/CICOHealth/user/exercise-logs"
                                   >Exericse Log</a
                                >
                            </li>
                            <li>
                                <a class="dropdown-item" href="/CICOHealth/user/statistics"
                                   >Statistics</a
                                >
                            </li>
                            <li>
