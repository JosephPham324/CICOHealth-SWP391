<%-- Document : expertProfile Created on : Mar 14, 2023, 7:34:43 AM Author :
                        ...
                        <li class="cert">
                            <div class="cert-wrapper">
                                ...
                                <div class="cert-info">
                                    ...
                                    <p class="cert-issuer"><span>Issuer: </span> ${certification.certIssuer}</p>
                                    <p class="cert-date"><span>Issue Date: </span>${certification.certDate}</p>
                                </div>
                                <c:if test="${allowUpdate}">
        ...
        <c:if test="${allowUpdate}">
            <div class="pop-up" id="cert-update">
                ...
                <div class="pop-up-content">
                    <form
                        id="frm-update-cert"
                        onsubmit="event.preventDefault();updateCert();"
                        >
