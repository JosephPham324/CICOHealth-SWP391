...
CREATE TABLE login (
    userID varchar(6) PRIMARY KEY NOT NULL REFERENCES [user](userID),
    username varchar(255) NOT NULL,
    passwordHash varchar(255) NOT NULL,
    passwordSalt varchar(255) NOT NULL,
    isGoogleLogin bit NOT NULL,
...
CREATE TABLE question (
    questionID varchar(6) PRIMARY KEY NOT NULL,
    submittedBy varchar(6) NOT NULL REFERENCES [user](userID),
    questionTopic text NOT NULL,
    questionContent text NOT NULL
);

CREATE TABLE answer (
    answerID varchar(6) PRIMARY KEY NOT NULL,
    createdBy varchar(6) NOT NULL REFERENCES [user](userID),
    questionTopic text NOT NULL,
    questionContent text NOT NULL
);

CREATE TABLE mealLog (
    userID varchar(6) NOT NULL REFERENCES [user](userID),
    mealLogID varchar(6) PRIMARY KEY NOT NULL,
...
CREATE TABLE mealLogItem (
    mealLogID varchar(6)  NOT NULL REFERENCES mealLog(mealLogID),
    itemID varchar(6) PRIMARY KEY NOT NULL,
...
CREATE TABLE ExerciseLog (
  ...
  exerciseLogID varchar(6) NOT NULL,
  exerciseID varchar(6) NOT NULL,
  logTime time NOT NULL,
  logDate date NOT NULL,
  [set] int,
...
CREATE TABLE paymentInfo (
  userID varchar(6) NOT NULL,
  paymentInfoID varchar(6) NOT NULL,
